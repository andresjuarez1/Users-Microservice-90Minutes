...
export class GetUserInfoSaga {
    private queueNameReq: string = process.env.RABBIT_QUEUE_GET_USER_INFO_REQ || 'default';
    private exchangeName: string = process.env.RABBIT_EXCHANGE_USER||'default';
    private routingKeyReq: string = process.env.RABBIT_ROUTING_KEY_GET_USER_INFO_REQ || 'default';
    private queueNameRes: string = process.env.RABBIT_QUEUE_GET_USER_INFO_RES || 'default';
    private routingKeyRes: string = process.env.RABBIT_ROUTING_KEY_GET_USER_INFO_RES || 'default';
